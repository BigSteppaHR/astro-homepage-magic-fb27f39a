...
// Define types for the FooterLink and FooterSection
type FooterLink = {
  title: string;
  href: string;
};
...
const Footer = () => {
  return (
    <footer className="bg-[#F8F9FF] pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div className="lg:col-span-2">
            <h2 className="text-2xl font-bold text-[#010D3E] mb-4">AstreyonAI</h2>
            <p className="text-gray-600 mb-6 max-w-md">
              The ultimate AI platform for creating high-quality content at scale. 
              Trusted by creators, marketers, and businesses worldwide.
            </p>
            <div className="flex space-x-4">
              <SocialIcon icon="social-x" link="https://x.com" />
              <SocialIcon icon="social-linkedin" link="https://linkedin.com" />
              <SocialIcon icon="social-insta" link="https://instagram.com" />
              <SocialIcon icon="social-youtube" link="https://youtube.com" />
              <SocialIcon icon="social-pin" link="https://pinterest.com" />
            </div>
          </div>
          
          {footerSections.map((section, index) => (
            <div key={index}>
              <h3 className="text-lg font-semibold text-[#010D3E] mb-4">{section.title}</h3>
        ...
        <div className="border-t border-gray-200 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">
              &copy; {new Date().getFullYear()} AstreyonAI. All rights reserved.
            </p>
            <div className="flex space-x-6">
              ...
              <a href="/cookies" className="text-gray-500 hover:text-blue-600 text-sm">Cookie Policy</a>
            </div>
          </div>
        </div>
      </div>
...
const SocialIcon = ({ icon, link }: { icon: string; link: string }) => {
  return (
    <motion.a 
      ...
      whileTap={{ scale: 0.95 }}
      className="w-10 h-10 flex items-center justify-center rounded-full bg-white text-gray-700 hover:text-blue-600 border border-gray-200 hover:border-blue-200 shadow-sm transition-colors"
      target="_blank"
